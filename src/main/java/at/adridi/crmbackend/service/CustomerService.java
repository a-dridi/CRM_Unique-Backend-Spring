...
public class CustomerService {
    ...
    /**
     * Get certain customer with the passed id. Throws
     * DataValueNotFoundException if customer is not available.
     *
     * @param id
     * @return
     */
    ...
    /**
     * Get certain customer with the passed email. Throws
     * DataValueNotFoundException if customer is not available.
     *
     * @param email
     * @return
    ...
    /**
     * Get customer list with the passed forename. Throws
     * DataValueNotFoundException if customers are not available.
     *
     * @param forename
     * @return
     */
    ...
    /**
     * Get customer list with the passed surname. Throws
     * DataValueNotFoundException if customers are not available.
     *
     * @param surname
     * @return
     ...
     * @return 0: OK. 1: Passed value is null. 2: Passed customer does not
     * exist, 3: E-Mail already exists and belongs to another customer. 4:
     * Update failed.
     */
